...
cgp_base = []
cgp_base_p_fits = []
cgp_1x_path = "../output/cgp_adaptive_1x/"
cgp_1x = []
cgp_1x_p_fits = []
cgp_2x_path = "../output/cgp_adaptive2x/"
cgp_2x = []
cgp_2x_p_fits = []
color_order = ['blue', 'lightgreen', 'red']
method_names = ["CGP", "CGP_Adaptive_1X", "CGP_Adaptive_2X"]
method_names_long = ["CGP", "CGP_Adaptive_1X", "CGP_Adaptive_2X"]
max_e = 50
...
plt.show()
plt.savefig("../output/figures/fit_adapt1.png")
...
for n in range(len(f_name)):
    ...
    axs[n].plot(cgp_1x_avgs[n], label='CGP_Adaptive_OnePoint', c=color_order[1])
    axs[n].plot(cgp_2x_avgs[n], label='CGP-Adaptive_TwoPoint', c=color_order[2])
    alpha = 0.05
...
plt.show()
plt.savefig("../output/figures/fitness_adapt2.png")
