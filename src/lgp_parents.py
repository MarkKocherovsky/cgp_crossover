...
class LgpParentGenerator:
    def __init__(self, max_p, max_r, max_d, bank, inputs, n_bias=10, arity=2, fixed_length=False):
    ...
    def get_registers(self):
        ...
        possible_destinations = np.delete(possible_indices,
                                          np.arange(1, self.n_bias + self.inputs + 1))  # removes inputs for destination
