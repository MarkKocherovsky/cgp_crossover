...
try:
    ...
    print(xover_method)
    run_name = f'cgp_diversity_{xover_method}_long'
except IndexError:
...
initial_unique = are_individuals_unique(parents)
print("Initial population is unique:", initial_unique)
...
for g in range(1, max_g + 1):
    ...
    xov_fitnesses, xov_alignment = processFitness(fitness_objects, train_x_bias, train_y, children, max_p, max_c, arity, opt=0)
    ...
    #print(parents)
    #exit(1)
    # Example usage after selection
    unique_parents = are_individuals_unique(parents)
    #print("All parents are unique:", unique_parents)
