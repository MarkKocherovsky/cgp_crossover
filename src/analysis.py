...
graph_path = "../output/"
crossover_methods = {
    'Canonical': Method('None', 'CGP(1+4)PM', 'CGP(1+4)PM', 'blue', 'solid'),
    'Canonical Full': Method('None/full', 'CGP(1+4)NM', 'CGP(1+4)NM', 'lightblue', 'solid'),
    # 'Canonical_NP': Method('None/full', 'CGP(1+4)-NP', 'CGP(1+4) - Node Preservation', 'dodgerblue', 'dashed'),
    'N-Point': Method('n_point', 'CGP(40+40)-1xPM', 'CGP(40+40) - One Point - PM', 'green', 'solid'),
    'N-Point Full': Method('n_point/full', 'CGP(40+40)-1xNM', 'CGP(40+40) - One Point - NM', 'lightgreen', 'solid'),
    'N-Point 1D': Method('n_point_1d', 'CGP(40+40)-1x1DPM', 'CGP(40+40) - One Point 1D - PM', 'limegreen', 'dotted'),
    'N-Point 1D Full': Method('n_point_1d/full', 'CGP(40+40)-1x1DNM', 'CGP(40+40) - One Point 1D - NM', 'darkgreen', 'dashdot'),
    'Uniform': Method('uniform', 'CGP(40+40)-UxPM', 'CGP(40+40) - Uniform - PM', 'deeppink', 'solid'),
    'Uniform Full': Method('uniform/full', 'CGP(40+40)-Ux-NM', 'CGP(40+40) - Uniform - NM', 'pink', 'solid'),
    'Uniform 1D': Method('uniform_1d', 'CGP(40+40)-Ux1DPM', 'CGP(40+40) - Uniform 1D - PM', 'hotpink', 'dotted'),
    'Uniform 1D Full': Method('uniform_1d/full', 'CGP(40+40)-Ux1DNM', 'CGP(40+40) - Uniform 1D - NM', 'indigo', 'dashdot'),
    'Subgraph': Method('subgraph', 'CGP(40+40)-SGxPM', 'CGP(40+40) - Subgraph - PM', 'orange', 'solid'),
    'Subgraph Full': Method('subgraph/full', 'CGP(40+40)-SGxNM', 'CGP(40+40) - Subgraph - NM', 'orangered', 'solid'),
