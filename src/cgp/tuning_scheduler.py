...
try:
    ...
    job_id = "beh"
    print("Warning: not running in SLURM")
...
# function_list = ['Koza3']
# function_list = ['Koza3', 'Nguyen5', 'Nguyen7', 'Ackley', 'Levy', 'Rastrigin', 'Diabetes', 'EnergyEfficiency']
# function_list = ['Rastrigin']
# function_list = ['Diabetes']
# function_list = ['Diabetes', 'EnergyEfficiency']
        ...
        if os.path.exists(log_file):
            with open(log_file, "r") as f:
                ...
                if "slurmstepd: error:" in log_contents:
                    ...
                    os.system('sbatch schedule_tuning.sb')
                    exit(0)
        else:
...
for function in function_list:
    ...
    for xover in xovers:
        ...
        for i in range(1):  # Create 50 jobs per function/xover combination
            job_name = f"kocherov_{f_no_space}_{xover}_tuning_t{i}"
...
python3 -u -m cgp.run {i} 1000 16 1 4 {xover} 0.5 full 0.5 paretotournament {function} --n_points 1 --n_elites 1 --problem_dimensions 1 --step_size 50 --tournament_size 4 --asexual_reproduction False --one_dimensional_xover False --tuning True
