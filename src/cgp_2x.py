...
for g in range(1, max_g + 1):
    ...
    xov_fitnesses, alignment = processFitness(fitness_objects, train_x_bias, train_y, children, max_p, max_c)
    children, mutated_inds, mutation_list = mutate(deepcopy(children), p_mut=p_mut)
